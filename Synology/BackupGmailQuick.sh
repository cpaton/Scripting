...
sh /volume1/Data/Backup/GMail/GMVault/gmvault_env_dsm6/bin/gmvault sync -t quick -d /volume1/Data/Backup/GMail/craigpaton@gmail.com/ craigpaton@gmail.com >> $LOGFILE 2>&1
[ $? != 0 ] && error_handler
